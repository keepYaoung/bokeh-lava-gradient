...
/// 80%→100% 흰색(#FAFAFA) 90% opacity. (바닥에서도 og 가 살짝 비침)
const Gradient _kOgLight2Mask = LinearGradient(
  ...
  colors: <Color>[
    ...
    Color(0xE6FAFAFA), // 80% 흰색 90%
    Color(0xE6FAFAFA), // 100% 흰색 90%
  ],
...
const Map<BokehTheme, _BokehPreset> _kPresets = <BokehTheme, _BokehPreset>{
  ...
  // ogLight — og 그라디언트 + 라이트 마스크(상단 오렌지, 50%부터 흰색)
  BokehTheme.ogLight: _BokehPreset(
    Color(0xFFC65318),
    <Color>[
      Color(0xFFFFE6B8),
      Color(0xFFFFD089),
